function comedia(){
  ...
  for (var i = 0; i < imgComedia.length; i++) {
    ...
    resultado.innerHTML += ('<section class="conteudo"><section class="imagem"><a href=' + linkComedia[i] + ' target="_blank"><img src=' + imgComedia[i] + ' class="cartaz"></a></section> <h3>' + nomeComedia[i] + '</h3></section>');
  }
  }
...
function romance(){
  ...
  for (var i = 0; i < imgRomance.length; i++) {
    ...
    resultado.innerHTML += ('<section class="conteudo"><section class="imagem"><a href=' + linkRomance[i] + ' target="_blank"><img src=' + imgRomance[i] + ' class="cartaz"></a></section> <h3>' + nomeRomance[i] + '</h3></section>');
  }
  }
...
function acao(){
  ...
  for (var i = 0; i < imgAcao.length; i++) {
    ...
    resultado.innerHTML += ('<section class="conteudo"><section class="imagem"><a href=' + linkAcao[i] + ' target="_blank"><img src=' + imgAcao[i] + ' class="cartaz"></a></section> <h3>' + nomeAcao[i] + '</h3></section>');
  }
  }
...
function ficcaoCientifica(){
  ...
  for (var i = 0; i < imgFiccaoCientifica.length; i++) {
    ...
    resultado.innerHTML += ('<section class="conteudo"><section class="imagem"><a href=' + linkFiccaoCientifica[i] + ' target="_blank"><img src=' + imgFiccaoCientifica[i] + ' class="cartaz"></a></section> <h3>' + nomeFiccaoCientifica[i] + '</h3></section>');
  }
  }
...
function documentario(){
  ...
  for (var i = 0; i < imgDocumentario.length; i++) {
    ...
    resultado.innerHTML += ('<section class="conteudo"><section class="imagem"><a href=' + linkDocumentario[i] + ' target="_blank"><img src=' + imgDocumentario[i] + ' class="cartaz"></a></section> <h3>' + nomeDocumentario[i] + '</h3></section>');
  }
  }
...
function serie(){
  ...
  for (var i = 0; i < imgSerie.length; i++) {
    ...
    resultado.innerHTML += ('<section class="conteudo"><section class="imagem"><a href=' + linkSerie[i] + ' target="_blank"><img src=' + imgSerie[i] + ' class="cartaz"></a></section> <h3>' + nomeSerie[i] + '</h3></section>');
  }
  }
...
function semCategoria(){
  ...
  for (var i = 0; i < imgSemCategoria.length; i++) {
    ...
    resultado.innerHTML += ('<section class="conteudo"><section class="imagem"><a href=' + linkSemCategoria[i] + ' target="_blank"><img src=' + imgSemCategoria[i] + ' class="cartaz"></a></section> <h3>' + nomeSemCategoria[i] + '</h3></section>');
  }
  }